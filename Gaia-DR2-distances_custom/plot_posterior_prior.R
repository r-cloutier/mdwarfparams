...
plot.post.prior <- function(w, wsd, rlen, rRes, rlo, rhi, rplotlo, rplothi, fname) {
  ...
  ## RC: save posterior PDF
  write.csv(cbind(rplot,dpost), file = paste("DistancePosteriors/",fname,".csv",sep=""))
